...
class Prostate(Dataset):
    ...
    def _get_bbox(self, mask: torch.Tensor, id) -> torch.Tensor:
        x_min, y_min, x_max, y_max = np.load(os.path.join(self.base_dir, self.domain_name[self.domain_idx], f'src_domain_idx_{self.src_domain}_75', id))
    ...
    def __getitem__(self, index):
        ...
        return img, mask.long(), bbox, bbox_gt, id
